...
public class SwerveModule extends SubsystemBase {
  ...
  public SwerveModule(
    ...
    // driveMotor = new WarriorSparkMax(driveMotorId,MotorType.kBrushless,driveConfig,
    // IdleMode.kCoast);
    driveMotor =
        new WarriorSparkMax(
            driveMotorId, MotorType.kBrushless, driveMotorReversed, IdleMode.kCoast, 45);
    turnMotor =
        new WarriorSparkMax(
            turnMotorId, MotorType.kBrushless, turnMotorReversed, IdleMode.kCoast, 25);
    // driveMotor = new PearadoxSparkMax(driveMotorId, MotorType.kBrushless, IdleMode.kCoast, 45,
    // driveMotorReversed);
    // turnMotor = new WarriorSparkMax(turnMotorId, MotorType.kBrushless, IdleMode.kCoast, 25,
    // turnMotorReversed);
    ...
    turnPIDController =
        new PIDController(Constants.SwerveConstants.KP_TURNING, 0, 0.001); // 0.001);
  ...
  public void setSpeed(SwerveModuleState desiredState) {
    driveMotor.set(
        desiredState.speedMetersPerSecond / Constants.SwerveConstants.DRIVETRAIN_MAX_SPEED);
  }
