...
private int driveMotorId;
  ...
  public SwerveModule(int driveMotorId, int turnMotorId, boolean driveMotorReversed, boolean turnMotorReversed,
    int absoluteEncoderId, double absoluteEncoderOffset) {
      ...
      //driveMotor = new WarriorSparkMax(driveMotorId,MotorType.kBrushless,driveConfig, IdleMode.kCoast);
      driveMotor = new WarriorSparkMax(driveMotorId, MotorType.kBrushless, driveMotorReversed, IdleMode.kCoast, 45);
      turnMotor = new WarriorSparkMax(turnMotorId,MotorType.kBrushless, turnMotorReversed, IdleMode.kCoast, 25);
      // driveMotor = new PearadoxSparkMax(driveMotorId, MotorType.kBrushless, IdleMode.kCoast, 45, driveMotorReversed);
      //turnMotor = new WarriorSparkMax(turnMotorId, MotorType.kBrushless, IdleMode.kCoast, 25, turnMotorReversed);
