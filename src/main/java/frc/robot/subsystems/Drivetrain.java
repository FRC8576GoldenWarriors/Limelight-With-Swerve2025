...
public class Drivetrain extends SubsystemBase {
  ...
  private final AprilTagStatsLimelight tagStats = new AprilTagStatsLimelight();
  ...
  public Drivetrain() {
    ...
    m_publisher =
        NetworkTableInstance.getDefault()
            .getStructTopic(Constants.VisionConstants.nameConstants.publishName, Pose2d.struct)
            .publish();
  }
